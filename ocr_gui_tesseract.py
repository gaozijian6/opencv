# -*- coding: utf-8 -*-
"""
使用 Tesseract OCR 的 GUI 版本（避免 PyTorch 兼容性问题）
"""
...
class TesseractOCRApp:
    def __init__(self, root):
        self.root = root
        self.root.title("数字 OCR 识别（Tesseract版本）")
    ...
    def setup_ui(self):
        ...
        info_label = tk.Label(
            self.root,
            text="使用 Tesseract OCR（避免 PyTorch 兼容性问题）",
            font=("Arial", 10),
            fg="#666666"
        )
        info_label.pack()
    ...
    def recognize_image(self):
        ...
        try:
            # 使用 Tesseract 识别
            numbers = self.recognize_numbers_tesseract(self.current_image)
    ...
    def recognize_numbers_tesseract(self, image):
        """使用 Tesseract 识别数字"""
